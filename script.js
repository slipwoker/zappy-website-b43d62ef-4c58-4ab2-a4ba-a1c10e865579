document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function getErrorMessage(field, type) {
      ...
      const messages = {
        ...
        minlength: 'Please enter at least ' + field.getAttribute('minlength') + ' characters.'
      };
    ...
    function clearError(field) {
      ...
      const existingError = document.getElementById('error-' + field.id || field.name);
      if (existingError) {
        existingError.remove();
      }

      const siblingError = field.parentElement
    ...
    function validateField(field) {
      ...
      if (isValid && field.type === 'email' && value.trim() !== '') {
      ...
      if (isValid && field.type === 'tel' && value.trim() !== '') {
        if (!validators.tel(value)) {
          isValid = false;
          errorMessage = getErrorMessage(field, 'tel');
        }
      }

      if (isValid && field.hasAttribute('minlength') && value.trim() !== '') {
        if (!validators.minlength(value, field.getAttribute('minlength'))) {
          isValid = false;
  ...
  const animationElements = document.querySelectorAll(OBSERVE_SELECTOR);
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'b43d62ef-4c58-4ab2-a4ba-a1c10e865579',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'b43d62ef-4c58-4ab2-a4ba-a1c10e865579';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'b43d62ef-4c58-4ab2-a4ba-a1c10e865579';
